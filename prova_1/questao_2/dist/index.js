...
const produtoEletronico_1 = require("./produtoEletronico");
const produto1 = new produtoEletronico_1.ProdutoEletronico("PC", "Lenovo", 4000, 2);
...
const produto2 = new produtoEletronico_1.ProdutoEletronico("Mouse", "Logitech");
